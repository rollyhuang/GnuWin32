...
:: version: 0.6.3
::
:: Copyright (c) 2009 - 2013 by Mathias Michaelis <michaelis@tcnet.ch>
:: Copyright (c) 2009 - 2013 by Jay Satiro <raysatiro@users.sourceforge.net>
::
:: -------------------------------------------------------------------
::
...
:command_line
set GNUWIN32_ARGV=%1
if not defined GNUWIN32_ARGV goto command_line_end
set GNUWIN32_ARGV=%GNUWIN32_ARGV:"=%

if "%GNUWIN32_ARGV%"=="-v" goto set_verbose
if "%GNUWIN32_ARGV%"=="/v" goto set_verbose
if "%GNUWIN32_ARGV%"=="-m" goto set_hash_missing_is_ok
if "%GNUWIN32_ARGV%"=="/m" goto set_hash_missing_is_ok
if "%GNUWIN32_ARGV%"=="-j" goto set_just_testing
if "%GNUWIN32_ARGV%"=="/j" goto set_just_testing
if "%GNUWIN32_ARGV%"=="-h" goto show_help_text
if "%GNUWIN32_ARGV%"=="/h" goto show_help_text
if "%GNUWIN32_ARGV%"=="-?" goto show_help_text
if "%GNUWIN32_ARGV%"=="/?" goto show_help_text
if "%GNUWIN32_ARGV%"=="--help" goto show_help_text
if "%GNUWIN32_ARGV%"=="--version" goto show_version_text
set GNUWIN32_INSTALL_DIRECTORY=%GNUWIN32_ARGV%
shift
goto command_line
...
echo = Copyright (c^) 2013 by Mathias Michaelis, ^<michaelis@tcnet.ch^>
echo = Copyright (c^) 2013 by Jay Satiro, ^<raysatiro@users.sourceforge.net^>
...
cd /d "%GNUWIN32_INSTALL_DIRECTORY%"
if errorlevel 1 (
	echo =
